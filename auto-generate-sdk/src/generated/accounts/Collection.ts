...
export type CollectionArgs = {
  comptoirKey: web3.PublicKey
  name: string
  symbol: string
  requiredVerifier: web3.PublicKey
  fees: beet.COption<number>
...
export class Collection implements CollectionArgs {
  private constructor(
    readonly comptoirKey: web3.PublicKey,
    readonly name: string,
    readonly symbol: string,
    readonly requiredVerifier: web3.PublicKey,
    readonly fees: beet.COption<number>,
    readonly ignoreCreatorFee: boolean
  ) {}
  ...
  static fromArgs(args: CollectionArgs) {
    return new Collection(
      ...
      args.name,
      args.symbol,
      args.requiredVerifier,
      args.fees,
      args.ignoreCreatorFee
    )
  }
  ...
  pretty() {
    return {
      comptoirKey: this.comptoirKey.toBase58(),
      name: this.name,
      symbol: this.symbol,
      requiredVerifier: this.requiredVerifier.toBase58(),
      fees: this.fees,
      ignoreCreatorFee: this.ignoreCreatorFee,
    }
  }
}
...
>(
  [
    ...
    ['comptoirKey', beetSolana.publicKey],
    ['name', beet.utf8String],
    ['symbol', beet.utf8String],
    ['requiredVerifier', beetSolana.publicKey],
    ['fees', beet.coption(beet.u16)],
    ['ignoreCreatorFee', beet.bool],
  ],
  Collection.fromArgs,
  'Collection'
)
